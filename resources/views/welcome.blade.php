...
<head>
    ...
    <title>Include Section Practice</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{route('Loginform')}}">Login</a>
                </li>
            </ul>
            ...
            @if(session()->has('email'))
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link active">{{ session('email') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('show-students')}}">Students</a>
                    </li>
                    <li class="nav-item">
